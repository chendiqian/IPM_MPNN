...
class PartialConv(MessagePassing):
    # adapted from https://pytorch-geometric.readthedocs.io/en/latest/generated/torch_geometric.nn.conv.GENConv.html#torch_geometric.nn.conv.GENConv
    def __init__(
        self,
